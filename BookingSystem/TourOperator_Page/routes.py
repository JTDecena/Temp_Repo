...
# def get_tour_package(package_id):
#     package = TourPackage.query.get_or_404(package_id)
#     estimated_prices = EstimatedPrice.query.filter_by(package_id=package_id).all()
#     inclusions = Inclusion.query.filter_by(package_id=package_id).all()
#     exclusions = Exclusion.query.filter_by(package_id=package_id).all()
#     itineraries = Itinerary.query.filter_by(package_id=package_id).all()

#     package_data = {
#         "name": package.name,
#         "description": package.description,
#         "package_img": package.package_img,
#         "estimated_prices": [{"description": p.description, "estimated_price": p.estimated_price} for p in estimated_prices],
#         "inclusions": [{"inclusion": i.inclusion} for i in inclusions],
#         "exclusions": [{"exclusion": e.exclusion} for e in exclusions],
#         "itineraries": [{"title": i.title, "subtitle": i.subtitle} for i in itineraries]
#     }
#     return jsonify(package_data)
